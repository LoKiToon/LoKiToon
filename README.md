...
<ul>
    ...
    <li>I live in Saudi Arabia. 🇸🇦</li>
    <li>I can partially speak (and understand) Arabic.</li>
    <li>I like to make 3D characters using Blender.</li>
    <li>I also like coding with Python, and HTML5. I would often use <a
